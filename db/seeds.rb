...
puts 'seeding visits'
visit1 = Visit.create!(viewer_id: v1.id, date: 20221204, comment: 'eh')
visit2 = Visit.create!(viewer_id: v1.id, date: 20221204, comment: 'eh')
visit3 = Visit.create!(viewer_id: v1.id, date: 20221204, comment: 'eh')
puts 'visits seeded'
